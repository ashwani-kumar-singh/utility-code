...
/**
 * - <a href="https://mkyong.com/java8/java-8-flatmap-example/">...</a>
 * - <a href="https://howtodoinjava.com/java8/stream-map-vs-flatmap/">...</a>
 ...
 *
 * @link <a href="https://1drv.ms/w/s!Am8pK68xxrsT7hRe-fL-r5u6tTTM?e=kRPdot">...</a>
 */
public class FlatMap {
    ...
    private static void flatMapHelper2() {
        ...
        list.add(obj1);
        list.add(obj2);
        list.stream().map(Student::getBook).flatMap(innerList -> innerList.stream()).distinct()
